...
function Visions() {
    return (
      ...
      //   </div>
      // </MDBContainer>
      <div breakpoint='lg' className='d-grid justify-content-between align-items-center my-4 gx-5 pt-2 pt-lg-4 mx-auto p-lg-5'>
        <h1 className='titleBawah devAlign text-left' style={{}}>VISIONS/MISSIONS/GOALS</h1>
        <MDBRow className=''>
          <MDBCol lg='4' className='borderRed align-items-center justify-content-center pt-3 mx-lg-2'>
            <p>Our mission to maintain a high degree of customer satisfaction, trust, integrity, and reliability through delivering quality services conforming to industry best practices, while constantly continuing to improve our standard and processes</p>
          </MDBCol>
          <MDBCol lg='4' className='borderRed align-items-center justify-content-center pt-3 mx-lg-2'>
            <p>Our vision to be recognized as a national class leader in the installation, repair, and maintenance of large bore marine diesel engines and generators. We strive to the exceed the highest standard and our quality of our work, our commitment to on timme delivery and for providing excellent customer value</p>
          </MDBCol>
          <MDBCol lg='4' className='borderRed align-items-center justify-content-center pt-3 mx-lg-2'>
            <p>We recognized that our strength is the quality of the people who comprise our corporate team. Our commitment to their job satisfaction , their individual personal and professional growth, and to the synergy of our team</p>
          </MDBCol>
        </MDBRow>
      </div>
    );
