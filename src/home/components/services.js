...
import {MDBCol, MDBRow, MDBListGroup, MDBListGroupItem} from 'mdb-react-ui-kit'

function Services(){
    return(
    <div className='d-flex flex-column justify-content-center align-items-center pt-2 pt-lg-4 mx-auto p-lg-5 p-5'>
        ...
        <div className='d-flex flex-column justify-content-center align-items-center pt-2 pt-lg-2 mx-auto p-lg-5 p-5'>
