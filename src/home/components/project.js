...
function Project(){
    return(
    <div className='d-flex flex-column pt-2 pt-lg-4 p-lg-5 p-5' style={{background:'#EEEEEE', height: 'max-content', }}>
        ...
        <div className="d-flex flex-column justify-content-between mx-auto">
            <MDBRow className="mb-4 gx-5">
                <MDBCol lg='6' className="mb-lg-4 mb-4" >
                    <div className="hover-overlay bg-image">
                        <img alt="Project 1" src={card1} className="img-fluid"></img>
                        <a href="#!">
                ...
                <MDBCol lg='6'>
                <div className="hover-overlay bg-image">
                        <img alt="Project 2" src={card2} className="img-fluid"></img>
                        <a href="#!">
                            <div className='mask overlay' style={{ backgroundColor: 'rgba(57, 192, 237, 0.2)' }}></div>
                        </a>
                    </div>
            ...
            <MDBRow className="mb-4 gx-5">
                <MDBCol lg='6' className="mb-lg-4 mb-4">
                <div className="hover-overlay bg-image">
                        <img alt="Project 3" src={card3} className="img-fluid"></img>
                        <a href="#!">
                            <div className='mask overlay' style={{ backgroundColor: 'rgba(57, 192, 237, 0.2)' }}></div>
                        </a>
                    </div>
                ...
                <MDBCol lg='6'>
                <div className="hover-overlay bg-image">
                        <img alt="Project 4" src={card4} className="img-fluid"></img>
                        <a href="#!">
                            <div className='mask overlay' style={{ backgroundColor: 'rgba(57, 192, 237, 0.2)' }}></div>
                        </a>
                    </div>
